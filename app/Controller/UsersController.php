 ...
 */
	...
	//user logged in
		...
		$this->request->data['User']['created_by'] = $current_user['username'];
			...
			$systemGroups = $this->User->SystemGroup->find('list',array('fields'=>array('id','account_type_name'),'conditions'=>array('SystemGroup.id'=>array(1,2,3))));
		   }
		$this->set(compact('systemGroups'));
	}
 ...
 */
	public function edit($id = null) {
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			...
			$systemGroups = $this->User->SystemGroup->find('list',array('fields'=>array('id','account_type_name')));
			$departments = $this->User->Department->find('list',array('fields'=>array('id','department_name'))); 
