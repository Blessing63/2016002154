...
<title>Huzhou University Library Management System:: <?php echo $title_for_layout?></title>
</head>
...
<h4><ul>		
		...
		<li><?php echo $this->Html->link(__('Settings'), array('controller'=>'users','action' => 'admin_password')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
		</ul></h4>
		<?php }?>	
...
<h4><ul>		
		...
		<li><?php echo $this->Html->link(__('Students'), array('controller'=>'StudentDetails','action' => 'index')); ?></li>
		<li><?php echo $this->Html->link(__('Settings'), array('controller'=>'users','action' => 'admin_password')); ?></li>
		</ul></h4>
		<?php }?>
...
<div id="footer">
Copyright &copy; <?php echo date('Y'); ?> Huzhou University Library Management System(Blessing Zenda)
</div>
